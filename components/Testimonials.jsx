...
export default function TestimonialsCarousel() {
  return (
    <section id="clients">
      <div className="relative min-h-screen flex flex-col justify-center items-center px-5 py-14 bg-surface-a0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center w-full max-w-6xl">
          ...
          <div className="max-w-sm sm:max-w-md md:max-w-lg text-center md:text-left">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-100 tracking-tight">
              A smile is an{" "}
              <span className="text-primary-a30">inexpensive</span> way to
              change your looks
            </h2>
        ...
        <div className="mt-20">
          <p className="text-zinc-300 mb-4 text-center">ALX Certified</p>
          <Certified />
        </div>
